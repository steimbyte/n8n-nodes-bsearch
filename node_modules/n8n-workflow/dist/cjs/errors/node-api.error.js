(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "xml2js", "../utils", "./abstract/node.error", "../constants"], factory);
    }
    ...
    class NodeApiError extends node_error_1.NodeError {
        ...
        setDescriptionFromXml(xml) {
            (0, xml2js_1.parseString)(xml, {
                explicitArray: false,
                tagNameProcessors: [utils_1.sanitizeXmlName],
                attrNameProcessors: [utils_1.sanitizeXmlName],
            }, (_, result) => {
                if (!result)
                    return;
